...
import { AnnotationTemplate, AnnotationTemplatesService } from '../../../../core/services/annotation-templates.service';
...
import { FieldType, PageAnnotations, PageField } from '../../../../shared/models/annotation.model';
...
export class EditorHomePageComponent implements AfterViewChecked, OnDestroy, OnInit {
  ...
  private readonly editorBootstrap = inject(EditorBootstrapService);
  ...
  ngOnInit() {
    const pendingFile = this.editorBootstrap.consumePendingFile();
    if (pendingFile) {
      queueMicrotask(() => {
        this.loadPdfFile(pendingFile);
      });
    }
  }
