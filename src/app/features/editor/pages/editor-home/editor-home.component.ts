...
export class EditorHomeComponent implements AfterViewChecked, OnDestroy, OnInit {
  /**
   * Container page for the private editor area. It orchestrates the PDF
   * rendering workflow while delegating presentation concerns to toolbar,
   * sidebar and viewer child components.
   */
  ...
  ngOnInit() {
    const pendingFile = this.fileQueue.consumePendingFile();
    if (pendingFile) {
